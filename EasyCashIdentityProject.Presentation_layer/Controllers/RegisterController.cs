		...
		public async Task<IActionResult> Index(AppUserRegisterDto appUserRegisterDto)
		{
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					MailboxAddress mailboxAddressFrom = new MailboxAddress("Easy Cash Admin", "serkankemer06@gmail.com"); // Mail kimden gidecek
					...
					client.Authenticate("serkankemer06@gmail.com", "uojvpeivmkfyqiej");
